...
+ (AVFrame *)getPCMAVFrameFromOtherFormat:(AVFrame *)frame {
    SwrContext *swrContext = swr_alloc_set_opts(NULL, AV_CH_FRONT_CENTER, AV_SAMPLE_FMT_S32, 48000, frame->channel_layout, frame->format, frame->sample_rate, 0, 0);
    if (swrContext == NULL) {
    ...
    RGBFrame->channel_layout = AV_CH_FRONT_CENTER;
